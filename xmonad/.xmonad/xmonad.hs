...
myLayoutHook = avoidStruts 
  ...
  where 
    ...
    reflectXToggle = mkToggle (single REFLECTX) 
    reflectYToggle = mkToggle (single REFLECTY) 
...
myWorkspaces :: [String]   
myWorkspaces = clickable . (map xmobarEscape) $ ["www","chat","dev","game","media","aux"]
  where 
